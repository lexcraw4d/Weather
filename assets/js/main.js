...
//Clear previous search data
    let emptyArr=["location","uvi","temp","sideIcon","wind","humid","icon","currentDay","icon1","dayOne","dayOneSub","icon2","dayTwo","dayTwoSub","icon3","dayThree","dayThreeSub","icon4","dayFour","dayFourSub","icon5","dayFive","dayFiveSub"];
